    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10 lg:py-14">
      <div className="mb-10">
        ...
        <p className="text-muted-foreground mt-2 max-w-xl">
          Explore articles and queries organized by subject area across the
          breadth of Islamic scholarship.
        </p>
      </div>

      {/* Article Topics */}
      <section className="mb-10">
        <h2 className="text-lg font-semibold mb-4">Article Topics</h2>
      ...
      {queryTopics.length > 0 && (
        <section>
          <h2 className="text-lg font-semibold mb-4">Query Topics</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
